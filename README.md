...
End-to-end data analytics project using Microsoft Excel to analyze hotel booking cancellation patterns. Includes data cleaning with Power Query, calculated columns, pivot table analysis, dashboard creation, and interactive reporting for hospitality insights.
...
Transformed raw booking data into structured insights through cleaning, pivot analysis, and interactive visualization.
